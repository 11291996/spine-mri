...
if __name__ == "__main__":
    ...
    logger = TrainLogger(log_dir=save_dir, prefix=f"train_cunet_{args.original_modal}_{args.target_modal}")
    ...
    mdn_model_path = os.path.join(args.save_dir, model_type, subject_name, dataset_name, f'mdn_{args.original_modal}_{args.target_modal}.pth')
